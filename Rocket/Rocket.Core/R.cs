    ...
    public class R : MonoBehaviour
    {
        ...
        {   
            ...
            try
            {
                ...
                Translation = new XMLFileAsset<TranslationList>(String.Format(Environment.TranslationFile, Settings.Instance.LanguageCode), [typeof(TranslationList), typeof(TranslationListEntry)
                ], defaultTranslations);
